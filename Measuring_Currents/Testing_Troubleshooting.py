...
initial_state = state_generation(basis_states, {'1a1a': (-0.0578042219+0j), '1a1b': (-0.3847333448+0j), '1a2a': (0.3847333448+0j), '1a2b': (0.4022886719+0j), '1b1b': (-0.0932018846+0j), '1b2a': (0.4711995322+0j), '1b2b': (0.3847333448+0j), '2a2a': (-0.0932018846+0j), '2a2b': (-0.3847333448+0j), '2b2b': (-0.0578042219+0j)}
)
initial_state = state_generation(basis_states, {'1b2b': (-1),
                                                '1a2a': (1),
                                                '1a2b': (1j),
                                                '1b2a': (1j)})
initial_state = state_generation(basis_states, {'1a3b': 1})
...
#                                                 '1a2b': (1j),
#                                                 '1b2a': (1j)})
# initial_state = state_generation(basis_states, {'3b': 1})

# initial_state = state_generation(basis_states, {'1b2b': (1j),
#                                                 '1a2a': (1j),
#                                                 '1a2b': (1),
#                                                 '1b2a': (-1)})
...
t = np.linspace(0,0.0084 * 10, 500) #in us


detuning_measurement = 100 * g

Measure_currents = True
current_measurements = [['1a', '1b'], ['2a', '2b']]
current_measurements = [['1a', '2a'], ['3b', '3a']]


skip_number = 10
Measure_correlations = True
current_correlations = [['1a', '1b'], ['2a', '2b']]
current_correlations = [['1a', '2a'], ['3b', '3a']]
