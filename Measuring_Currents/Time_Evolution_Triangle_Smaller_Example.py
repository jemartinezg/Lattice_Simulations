...
coupling_dictionary_NN = {'aa': g, 'ba': 0*g, 'bb': g}     # Coupling to nearest unit cell
...
initial_state = state_generation(basis_states, {'1a3a': (1), '1a3b': (0-1j), '1b3a': (1j), '1b3b': (1)})
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
print(np.round(correlation_Hamiltonian.real / (2*np.pi)), 3)
