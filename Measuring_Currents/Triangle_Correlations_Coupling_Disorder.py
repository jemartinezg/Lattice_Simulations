...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
basis_labels = ['1a', '1b', '1c', '1d', '1e', '1f', '1g', '1h']

g = -5 * 2 * np.pi    #In MHz and time in us
U= -150 * 2 * np.pi
e = 0
coupling_disorder = 1 * 2 * np.pi

detuning = []
for i in range(13):
    detuning.append(coupling_disorder * (2 * np.random.rand(1)[0] - 1))
print(detuning)
coupling_dictionary_same = {'ab' : g + detuning[0],
                            'ac': 2 * g + detuning[1],
                            'bc': g + detuning[2],
                            'bd': 2 * g + detuning[3],
                            'cd': g + detuning[4],
                            ...
                            'fg': g + detuning[10],
                            'fh': 2 * g + detuning[11],
                            'gh': g + detuning[12]}  #Coupling within a unit cell
coupling_dictionary_NN = {}     # Coupling to nearest unit cell
...
current_correlations = [[['1a', '1b'], ['1c', '1d']],
                        [['1a', '1b'], ['1e', '1f']],
                        [['1a', '1b'], ['1g', '1h']],
                        ]
...
# print(np.round(Evolution_H.real/2/np.pi, 1))
